...
public class Perks_EditAccountTest extends iTestCasePerksSauce {
    String date;
    String emailClient;
    String[] emailFriends;

    public Perks_EditAccountTest() {
...
//    @Test (dependsOnGroups = "perksSmoke", retryAnalyzer = Analyzer.class)
//    public void doHomePageChecksLoggedIn() {
//        doChecksCityHomePageLoggedIn();
//    }

//    @Test (dependsOnGroups = "perksSmoke", retryAnalyzer = Analyzer.class)
//    public void doHomePageChecksLoggedOut() {
//        doChecksCityHomePageLoggedOut();
//    }
